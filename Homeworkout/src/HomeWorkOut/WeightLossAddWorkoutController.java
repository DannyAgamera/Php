 ...
 */
public class WeightLossAddWorkoutController implements Initializable {
Stage dialogStage = new Stage();
    ...
    public WeightLossAddWorkoutController(){
    ...
    public void addWorkout(ActionEvent event){
        ...
        String sql = "INSERT INTO weightloss(workout, reps, sets) VALUES (?,?,?);";
        try{
    ...
    //add alert box after add attempt
